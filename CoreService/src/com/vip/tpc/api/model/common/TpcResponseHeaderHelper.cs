...
namespace com.vip.tpc.api.model.common{
	...
	public class TpcResponseHeaderHelper : TBeanSerializer<TpcResponseHeader>
	{
		
		public static TpcResponseHeaderHelper OBJ = new TpcResponseHeaderHelper();
		
		public static TpcResponseHeaderHelper getInstance() {
			
			return OBJ;
		}
		
		
		public void Read(TpcResponseHeader structs, Protocol iprot){
		...
		public void Write(TpcResponseHeader structs, Protocol oprot){
		...
		public void Validate(TpcResponseHeader bean){
