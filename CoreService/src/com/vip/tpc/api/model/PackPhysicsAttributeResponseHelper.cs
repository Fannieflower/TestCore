...
namespace com.vip.tpc.api.model{
	...
	public class PackPhysicsAttributeResponseHelper : TBeanSerializer<PackPhysicsAttributeResponse>
	{
		
		public static PackPhysicsAttributeResponseHelper OBJ = new PackPhysicsAttributeResponseHelper();
		
		public static PackPhysicsAttributeResponseHelper getInstance() {
			
			return OBJ;
		}
		
		
		public void Read(PackPhysicsAttributeResponse structs, Protocol iprot){
		...
		public void Write(PackPhysicsAttributeResponse structs, Protocol oprot){
		...
		public void Validate(PackPhysicsAttributeResponse bean){
