...
namespace com.vip.tpc.api.model{
	...
	public class AnormalResponseHelper : TBeanSerializer<AnormalResponse>
	{
		
		public static AnormalResponseHelper OBJ = new AnormalResponseHelper();
		...
		public void Read(AnormalResponse structs, Protocol iprot){
		...
		public void Write(AnormalResponse structs, Protocol oprot){
		...
		public void Validate(AnormalResponse bean){
